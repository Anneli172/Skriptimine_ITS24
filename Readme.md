...
sudo nano /etc/rsyslog.d/99-discard-rsyslog.conf

if $programname == 'rsyslogd' then stop
# või täpsemalt rsyslogi start/stop sõnumitele
if $msg contains 'imuxsock: Acquired UNIX socket' then stop
if $msg contains '[origin software="rsyslogd"' then stop
if $msg contains 'exiting on signal 15' then stop
